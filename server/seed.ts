...
async function seed() {
  ...
  try {
    ...
    const [op1, op2] = await db.insert(operations).values([
      {
        name: "Shanghai to Los Angeles FCL Shipment",
        description: "40ft container of electronics from Shanghai to Los Angeles port",
        status: "in-progress",
        priority: "high",
        clientId: client1.id,
        ...
        projectCurrency: "USD",
        courier: "Maersk Line",
        pickUpAddress: "123 Factory Road, Shanghai, China 200000",
        deliveryAddress: "456 Warehouse Ave, Los Angeles, CA 90001",
        bookingTracking: "MAEU123456789",
        pickUpDate: new Date("2025-10-05"),
        etd: new Date("2025-10-10"),
        eta: new Date("2025-11-15"),
        mblAwb: "MAEU123456789",
        hblAwb: "HBL987654321",
      },
      {
        name: "Frankfurt to New York Air Freight",
        description: "Urgent medical equipment shipment via air freight",
        status: "planning",
        priority: "urgent",
        clientId: client2.id,
        ...
        insurance: "yes",
        projectCurrency: "EUR",
        courier: "DHL Aviation",
        pickUpAddress: "Industrial Park 5, Frankfurt, Germany 60549",
        deliveryAddress: "Medical Center District, New York, NY 10001",
        bookingTracking: "DHL98765ABC",
        pickUpDate: new Date("2025-11-16"),
        etd: new Date("2025-11-17"),
        eta: new Date("2025-11-18"),
        mblAwb: "AWB12345678",
        hblAwb: "HAWB87654321",
      },
    ]).returning();
